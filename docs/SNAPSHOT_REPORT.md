...
Generated on: Fri Nov 28 22:49:46 CET 2025
...
### 🔄 Main Workflow Snapshots:       30 total
...
| `01-initial-form-Chromium-win32.png` |  | Chromium, Firefox, WebKit |
...
| `02-form-filled-basic-fields-Chromium-win32.png` |  | Chromium, Firefox, WebKit |
...
| `03-form-private-sector-selected-Chromium-win32.png` |  | Chromium, Firefox, WebKit |
...
| `04-form-completed-ready-to-submit-Chromium-win32.png` |  | Chromium, Firefox, WebKit |
...
| `05-form-success-notification-Chromium-win32.png` |  | Chromium, Firefox, WebKit |
...
| `06-form-reset-after-submit-Chromium-win32.png` |  | Chromium, Firefox, WebKit |

### ✅ NDA Visibility Tests:       30 total
...
| `nda-01-initial-no-sector-nda-hidden-Chromium-win32.png` |  |  |
...
| `nda-02-government-sector-nda-visible-Chromium-win32.png` |  |  |
...
| `nda-03-government-sector-nda-checked-Chromium-win32.png` |  |  |
...
| `nda-04-private-sector-nda-hidden-Chromium-win32.png` |  |  |
...
| `nda-05-government-sector-nda-reset-unchecked-Chromium-win32.png` |  |  |
...
| `nda-06-nonprofit-sector-nda-hidden-Chromium-win32.png` |  |  |

### 🏛️ Government Customer Workflow:       25 total
...
| `gov-01-form-filled-before-sector-Chromium-win32.png` |  |  |
...
| `gov-02-government-sector-nda-visible-Chromium-win32.png` |  |  |
...
| `gov-03-complete-government-form-nda-checked-Chromium-win32.png` |  |  |
| `gov-04-government-customer-success` |  |  |
| `gov-04-government-customer-success-Chromium-linux.png` |  |  |
| `gov-04-government-customer-success-Chromium-win32.png` |  |  |
| `gov-05-form-reset-nda-hidden` |  |  |
| `gov-05-form-reset-nda-hidden-Chromium-linux.png` |  |  |
| `gov-05-form-reset-nda-hidden-Chromium-win32.png` |  |  |
...
---
*Report generated on Fri Nov 28 22:49:46 CET 2025*
